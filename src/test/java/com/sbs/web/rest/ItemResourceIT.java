...
class ItemResourceIT {
    ...
    private static final QuantityType DEFAULT_QUANTITY_TYPE = QuantityType.BALE;
    private static final QuantityType UPDATED_QUANTITY_TYPE = QuantityType.MTS;
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).quantityType(DEFAULT_QUANTITY_TYPE);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantityType(UPDATED_QUANTITY_TYPE);
        return item;
    }
    ...
    void createItem() throws Exception {
        ...
        assertThat(testItem.getQuantityType()).isEqualTo(DEFAULT_QUANTITY_TYPE);
    }
    ...
    void putExistingItem() throws Exception {
        ...
        updatedItem.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantityType(UPDATED_QUANTITY_TYPE);
        ...
        assertThat(testItem.getQuantityType()).isEqualTo(UPDATED_QUANTITY_TYPE);
    }
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantityType(UPDATED_QUANTITY_TYPE);
    ...
    void deleteItem() throws Exception {
        ...
        // Delete the item
        restItemMockMvc
            .perform(delete(ENTITY_API_URL_ID, item.getId().toString()).with(csrf()).accept(MediaType.APPLICATION_JSON))
