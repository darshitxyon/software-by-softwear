...
describe('Order e2e test', () => {
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="date"]`).type('2023-06-30T15:04').blur().should('have.value', '2023-06-30T15:04');

      cy.get(`[data-cy="updatedAt"]`).type('2023-07-01T11:59').blur().should('have.value', '2023-07-01T11:59');

      cy.get(`[data-cy="createdAt"]`).type('2023-06-30T23:15').blur().should('have.value', '2023-06-30T23:15');
