...
export default class Transport extends Vue {
  ...
  public retrieveAllTransports(): void {
  ...
  public prepareRemove(instance: ITransport): void {
  ...
  public removeTransport(): void {
    this.transportService()
      ...
      .then(() => {
        const message = 'A Transport is deleted with identifier ' + this.removeId;
